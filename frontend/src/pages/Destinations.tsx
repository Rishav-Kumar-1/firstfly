// Destinations.tsx — All travel destinations
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                {filtered.map((dest, i) => (
                  <Link key={dest.id} to={`/destinations/${dest.id}`}
                    ...
                    <div className="mt-4 text-xs font-semibold text-white/90 flex items-center gap-1">
                      Explore →
                    </div>
                  </Link>
                ))}
              ...
              {filtered.length === 0 && (
                <div className="text-center py-20">
                  ...
                  <button onClick={() => setSearch('')} className="text-blue-600 hover:underline">Clear search</button>
                </div>
              )}
            </>
          )}
